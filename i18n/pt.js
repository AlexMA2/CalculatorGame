const pt = {
  index: {
    ...
    footer: {
      developer: 'Desenvolvido por Alex Mamani 2021',
  ...
  instructions: {
    ...
    number of correct and incorrect answers, the operation of the mathematical problem where you have
    the correct answers and the time spent solving each problem.
    In the game, you will see two buttons at the top. The <span class="btn"> Back to main page </span>
    button is to go back to
    the page you first viewed.
    The <span class="btn"> Start Again </span>&nbsp;button is used to restart the game. Helpful when you
    think you have a lot of wrong
    answers.`
    ]
  },
  game: {
